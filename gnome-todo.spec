...
Source0  : https://download.gnome.org/sources/gnome-todo/40/gnome-todo-40.1.tar.xz
...
%prep
%setup -q -n gnome-todo-40.1
cd %{_builddir}/gnome-todo-40.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623857393
...
cp %{_builddir}/gnome-todo-40.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-todo/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/gnome-todo-40.1/subprojects/libadwaita/COPYING %{buildroot}/usr/share/package-licenses/gnome-todo/01a6b4bf79aca9b556822601186afab86e8c4fbf
